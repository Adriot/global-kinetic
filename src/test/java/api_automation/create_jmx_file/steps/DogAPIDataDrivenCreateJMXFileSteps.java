package api_automation.create_jmx_file.steps;
...
public class DogAPIDataDrivenCreateJMXFileSteps {
    private Logger log  = LogManager.getLogger(DogAPIDataDrivenCreateJMXFileSteps.class);
    ...
    @Before("@DogAPIDataDrivenCreateJMXFile")
    public void setup() {
