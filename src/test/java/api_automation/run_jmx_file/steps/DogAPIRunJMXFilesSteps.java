package api_automation.run_jmx_file.steps;
...
public class DogAPIRunJMXFilesSteps {
    private Logger log  = LogManager.getLogger(DogAPIRunJMXFilesSteps.class);
